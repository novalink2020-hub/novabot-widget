/* NovaBot v6.9.8 – Shadow DOM Loader
   يعمل مع:
   - ui.css
   - ui.html
*/
...
(function () {
  ...
  host.style.pointerEvents = "auto"; // مهم لتمكين الضغط داخل الواجهة
  ...
  function initNovaBot(root, options) {
    ...
    async function handleSend() {
      ...
      // لا نغلق الكيبورد – نعيد الفوكس على حقل الكتابة
      setTimeout(() => {
        input.focus({ preventScroll: true });
      }, 30);
      ...
      // حالة بطاقة المطوّر – نستخدم نص خاص
    ...
    // لا نسمح للزر أن يسرق الفوكس من حقل الكتابة (للموبايل)
